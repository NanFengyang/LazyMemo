package com.onlna.lazymemo.ArcMenu;
...
public class SatelliteMenu extends FrameLayout {
	...
	public void addItems(List<SatelliteMenuItem> items) {
		...
		for (SatelliteMenuItem menuItem : menuItems) {
			...
			ImageView cloneView = null;
			if (APPConfigure.Screen_Width > 720) {
				itemView = (ImageView) LayoutInflater.from(getContext())
						.inflate(R.layout.sat_item_cr_more720, this, false);
				cloneView = (ImageView) LayoutInflater.from(getContext())
						.inflate(R.layout.sat_item_cr_more720, this, false);
			} else {
				itemView = (ImageView) LayoutInflater.from(getContext())
